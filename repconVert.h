...
class repconVert: public repS, public conVerter{
    public:
	    ...
	    repconVert(unsigned int input=1, std::string m = "default message", unsigned int c=1);
		...
		Description:	convertMessage takes in an unsigned int r value greater than 9, 
				   		...
				   		It is the user's job to deallocate the memory properly.
